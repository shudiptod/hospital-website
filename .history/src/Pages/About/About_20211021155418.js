...
const About = () => {
    return (
        <div className="text-center w-full">
            ...
            >About Us</h2>
            <div className="w-full lg:flex lg:flex-row sm:flex-col  justify-evenly items-center">
            ...
            <div className="my-16 lg:flex lg:flex-row sm:flex-col items-center justify-evenly">
