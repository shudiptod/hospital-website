    ...
    return (
        <div className="text-center">
            ...
            <div className="flex justify-evenly">
                <img src="https://image.freepik.com/free-photo/young-female-doctor-posing-corridor-hospital_1303-21212.jpg" className="w-3/12 h-80 mx-auto rounded-md shadow-lg filter drop-shadow-xl" />
