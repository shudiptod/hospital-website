    ...
    return (
        <div className="text-center">
            ...
            <div className="flex justify-evenly items-center">
                <img src="https://image.freepik.com/free-photo/medical-workers-covid-19-vaccination-concept-confident-professional-doctor-female-nurse-blue-scrubs-stethoscope-show-thumbs-up-assure-guarantee-best-quality-service-clinic_1258-57360.jpg" className="w-3/12 h-64 mx-auto rounded-md shadow-lg filter drop-shadow-xl" />
