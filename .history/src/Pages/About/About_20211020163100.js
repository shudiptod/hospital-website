        ...
        <div className="text-center">
            ...
            <div className="my-16 flex items-center justify-evenly">
                <div className="w-5/12 my-5">
                    <h2 className="text-4xl text-center font-semibold text-gray-800 font-mono ">Improving The Quality Of Your Life Through Better Health.</h2>
                    <p className="text-justify font-thin text-gray-800 font-mono px-6"
