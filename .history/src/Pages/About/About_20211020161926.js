    ...
    return (
        <div className="text-center">
            ...
            <div className="flex justify-evenly items-center">
                ...
                <img src="https://image.freepik.com/free-photo/happy-doctor-holding-clipboard-with-patients_1098-2176.jpg" className="w-5/12 h-80 mx-auto rounded-md shadow-lg filter drop-shadow-xl" />
            </div>
        </div>
    );
};
