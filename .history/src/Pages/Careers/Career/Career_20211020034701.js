...
const Career = (props) => {
    ...
    return (
        <div className="divide-y-4 divide-solid divide-blue-300 container mx-auto lg:w-5/6 md:w-6/6 sm:w-5/6 h-full bg-gray-50 filter drop-shadow shadow-2xl border rounded-xl mt-7">
