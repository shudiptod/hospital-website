...
const TopServices = () => {
    ...
    return (
        <div id="services" className=" mt-11 border rounded-xl shadow ">
            <h2 className="text-3xl text-center font-semibold text-gray-800 font-mono my-10">Our Priority Services for you</h2>
