...
const CovidVaccine = () => {
    return (
        <div className="p-4 shadow-md rounded-md text-left text-md font-semibold w-full lg:w-6/12 sm:w-10/12">
            ...
            <button className="py-2 px-4 my-5 rounded-lg bg-gray-700 text-white font-semibold">Submit</button>
        </div >
    );
};
