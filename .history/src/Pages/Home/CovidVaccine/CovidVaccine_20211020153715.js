...
const CovidVaccine = () => {
    return (
        <div className="p-4 shadow-md rounded-md text-left text-md font-semibold" style={{ maxWidth: "400px" }}>
            <h2 className="text-center text-xl mt-8 mb-4">Covid Vaccine Registration</h2>
