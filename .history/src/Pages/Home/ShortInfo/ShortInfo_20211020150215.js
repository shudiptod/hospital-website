    ...
    return (
        <div className="w-10/12 flex text-white mt-16">
            <div className="w-4/12 bg-green-500 text-center rounded-l-lg py-3">
                ...
                <p className="text-sm w-8/12 my-5 mx-auto font-semibold">Please feel free to contact our friendly reception staff with any general or medical enquiry.</p>
            ...
            <div className="w-4/12 bg-indigo-700">
                <h3 className="text-xl text-white font-mono font-semibold">Doctors Timetable</h3>
                <p className="w-8/12 my-5 mx-auto font-semibold">
                    Qualified doctors available six days a week, view our timetable to make an appointment.</p>
                <div className="flex w-6/12 items-center justify-evenly mx-auto">
                    <FaPhoneAlt></FaPhoneAlt>
                    <h3 className="text-xl text-white font-mono font-semibold">0163333555</h3>
                </div>
