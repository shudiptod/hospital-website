...
import { FaArrowRight, FaPhoneAlt, FaRegClock } from 'react-icons/fa';

const ShortInfo = () => {
    return (
        <div className="w-10/12 lg:flex lg:flex-row sm:flex-col text-white mt-16">
            <div className="lg:w-4/12 bg-green-500 text-center rounded-l-lg py-4">
            ...
            <div className="lg:w-4/12 bg-blue-800 rounded-r-lg text-center py-4">
                ...
                <div className="w-8/12 grid grid-cols-1 divide-y-2 divide-white mx-auto my-5">
                    <div className="flex justify-between py-3">
                        <h3 className="text-sm ">Monday - Thursday </h3>
                        <h3 className="text-sm ">6:00 AM</h3>
                    </div>
                    <div className="flex justify-between py-3">
                        <h3 className="text-sm ">Friday - Saturday</h3>
                        <h3 className="text-sm ">8:00 AM</h3>
                    </div>
                    <div className="flex justify-between py-3">
                        <h3 className="text-sm">Sunday</h3>
