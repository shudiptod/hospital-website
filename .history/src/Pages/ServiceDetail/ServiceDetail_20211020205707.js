...
const ServiceDetail = () => {
    ...
    return (
        <div className="container">
            ...
            />
            <p className="w-6/12">Our Dermatology service provides treatment of skin diseases for elective and emergency patients. Dermatology is the study of the skin and skin diseases. We care for people who are in hospital, have been to hospital or need to come to hospital</p>
