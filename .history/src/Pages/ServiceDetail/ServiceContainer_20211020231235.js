...
const ServiceContainer = ({ service }) => {
    ...
    return (
        <div className="container mx-auto">
            <div className="mx-auto w-full shadow-2xl filter drop-shadow-2xl py-10 lg:mb-2 sm:mb-7">
                <h2 className="lg:text-3xl text-gray-800 font-mono font-semibold sm:text-xl">{name}</h2>
                <img src={img}
