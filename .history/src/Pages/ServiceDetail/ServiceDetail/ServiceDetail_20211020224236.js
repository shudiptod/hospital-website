        ...
        <div className="container mx-auto ">
            {
                single === undefined ? <></> :
                    <div className="mx-auto w-full shadow-2xl filter drop-shadow-2xl py-10">
                        <h2 className="text-3xl text-gray-800 font-mono font-semibold text-center">{single?.name}</h2>
                        <img src={single?.img}
                            className="mt-5 mx-auto w-6/12 h-96"
                        />
                        <p className="text-lg text-gray-800 text-justify font-mono mt-5 mx-auto w-6/12">{single?.details}</p>
