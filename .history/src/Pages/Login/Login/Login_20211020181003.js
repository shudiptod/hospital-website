                    ...
                    <>
                        ...
                        <div class="w-4/12 mx-auto border-2 rounded-md border-solid border-blue-900 px-6 py-8" >
                            <form onSubmit={(e) => { emailSignUp(e) }}>
                                ...
                                <div class="mb-6">
                                    <label htmlFor="name" class="text-sm font-medium text-gray-900 block mb-2">Name</label>
                                ...
                                <div class="mb-6">
                                    <label htmlFor="email" class="text-sm font-medium text-gray-900 block mb-2">Your email</label>
                                ...
                                <div class="mb-6">
                                    <label htmlFor="password" class="text-sm font-medium text-gray-900 block mb-2">Your password</label>
