...
const Login = () => {
    ...
    return (
        <div>
            ...
            <button onClick={signInUsingGoogle} className="px-4 py-2 leading-normal text-xl bg-white font-bold text-yellow-500  rounded-3xl
                border-2 border-yellow-900"><FaGoogle></FaGoogle></button>
        </div>
    );
};
