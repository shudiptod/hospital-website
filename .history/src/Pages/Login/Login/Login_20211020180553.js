        ...
        <div className="flex flex-col items-center w-full">
            {
                isNew ?
                    <>
                        ...
                        <h2 className=" select-nonetext-sm text-center font-semibold text-gray-800 font-mono mb-5">already have an account?
                    ...
                    <>
                        ...
                        <h2 className="text-sm text-center font-semibold text-gray-800 font-mono mb-5">Dont have an account?
