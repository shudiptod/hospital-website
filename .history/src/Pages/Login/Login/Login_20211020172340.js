...
const Login = () => {
    ...
    return (
        <div className="flex flex-col items-center w-full">
            ...
            <div className="w-4/12 mx-auto border-3 border-gray-700" >
            ...
            <h2 className="text-xl text-center font-semibold text-gray-800 font-mono mt-3">Sign In Using Google</h2>
