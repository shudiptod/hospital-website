            ...
            <div class="w-4/12 mx-auto border-2 rounded-md border-solid border-blue-900 px-6 py-8" >
                ...
                <form onSubmit={() => { signInWithEmail(email, password) }}>
                    ...
                    <div class="mb-6">
                        ...
                        <input onBlur={setEmail(e.target.value)} type="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="" />
                    </div>
