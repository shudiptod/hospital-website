...
const Header = () => {
    ...
    return (
        ...
        ">
            <h2 className="text-xl italic font-bold text-blue-800 filter drop-shadow-2xl select-none">Sunrise Medical</h2>
            ...
            <div className="w-3/12 flex  items-center justify-evenly justify-self-end">
                {user.displayName ?
                    <>
                        <img className="rounded-full h-10 w-10 flex items-center justify-center border-4 border-double border-indigo-600" src={user.photoURL} />
