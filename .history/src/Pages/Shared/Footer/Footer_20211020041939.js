...
const Footer = () => {
    return (
        <div className="mb-0 w-full bg-gray-900 text-white font-sans text-center p-3 flex flex-col justify-center footer-div">
            <div className="mx-auto grid grid-cols-3 w-10/12 pb-14 items-center justify-items-center text-center">
