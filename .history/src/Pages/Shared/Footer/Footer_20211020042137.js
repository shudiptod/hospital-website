        ...
        <div className="mb-0 w-full bg-blue-900 text-white font-sans text-center p-3 flex flex-col justify-center footer-div">
            <div className="mx-auto grid grid-cols-2 w-10/12 pb-14 items-center justify-items-center text-center">
                <div className="mx-auto w-full h-full">
                    ...
                    <p className="text-sm font-medium p-1 mx-auto w-3/12">Our goal is to deliver quality of care in a courteous, respectful, and compassionate manner. We hope you will allow us to care for you and strive to be the first and best choice for your family healthcare.</p>
                </div>
