    ...
    return (
        <div className="mb-0 w-full h-40 bg-gray-900 text-white font-sans text-center p-3 footer-div grid grid-cols-3">
            <div className="">
                ...
                <p className="text-sm font-medium p-1 wrap w-8/12">Our goal is to deliver quality of care in a courteous, respectful, and compassionate manner. We hope you will allow us to care for you and strive to be the first and best choice for your family healthcare.</p>
            </div>
            <div className="">
